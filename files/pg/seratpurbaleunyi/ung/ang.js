var v3D = function () { 
	...
	Wall.prototype.anim = function () { 
		...
		if(y[3] >= y[2]){ 
			...
			css.borderColor = "#000 transparent transparent transparent"; 
